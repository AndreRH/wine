...
int box64_dynarec_log = env::getEnvVar("BOX64_DYNAREC_LOG") ? atoi(env::getEnvVar("BOX64_DYNAREC_LOG")) : 0;
int box64_dynarec = env::getEnvVar("BOX64_DYNAREC") ? atoi(env::getEnvVar("BOX64_DYNAREC")) : 1;
int box64_dynarec_dump = env::getEnvVar("BOX64_DYNAREC_DUMP") ? atoi(env::getEnvVar("BOX64_DYNAREC_DUMP")) : 0;
int box64_dynarec_forced = env::getEnvVar("BOX64_DYNAREC_FORCED") ? atoi(env::getEnvVar("BOX64_DYNAREC_FORCED")) : 0;
int box64_dynarec_bigblock = env::getEnvVar("BOX64_DYNAREC_BIGBLOCK") ? atoi(env::getEnvVar("BOX64_DYNAREC_BIGBLOCK")) : 1;
int box64_dynarec_forward = env::getEnvVar("BOX64_DYNAREC_FORWARD") ? atoi(env::getEnvVar("BOX64_DYNAREC_FORWARD")) : 128;
int box64_dynarec_strongmem = env::getEnvVar("BOX64_DYNAREC_STRONGMEM") ? atoi(env::getEnvVar("BOX64_DYNAREC_STRONGMEM")) : 0;
int box64_dynarec_x87double = env::getEnvVar("BOX64_DYNAREC_X87DOUBLE") ? atoi(env::getEnvVar("BOX64_DYNAREC_X87DOUBLE")) : 0;
int box64_dynarec_fastnan = env::getEnvVar("BOX64_DYNAREC_FASTNAN") ? atoi(env::getEnvVar("BOX64_DYNAREC_FASTNAN")) : 1;
int box64_dynarec_fastround = env::getEnvVar("BOX64_DYNAREC_FASTROUND") ? atoi(env::getEnvVar("BOX64_DYNAREC_FASTROUND")) : 1;
int box64_dynarec_safeflags = env::getEnvVar("BOX64_DYNAREC_SAFEFLAGS") ? atoi(env::getEnvVar("BOX64_DYNAREC_SAFEFLAGS")) : 1;
int box64_dynarec_callret = env::getEnvVar("BOX64_DYNAREC_CALLRET") ? atoi(env::getEnvVar("BOX64_DYNAREC_CALLRET")) : 0;
int box64_dynarec_hotpage = env::getEnvVar("BOX64_DYNAREC_HOTPAGE") ? atoi(env::getEnvVar("BOX64_DYNAREC_HOTPAGE")) : 0;
int box64_dynarec_fastpage = env::getEnvVar("BOX64_DYNAREC_FASTPAGE") ? atoi(env::getEnvVar("BOX64_DYNAREC_FASTPAGE")) : 0;
int box64_dynarec_bleeding_edge = env::getEnvVar("BOX64_DYNAREC_BLEEDING_EDGE") ? atoi(env::getEnvVar("BOX64_DYNAREC_BLEEDING_EDGE")) : 1;
int box64_dynarec_jvm = env::getEnvVar("BOX64_DYNAREC_JVM") ? atoi(env::getEnvVar("BOX64_DYNAREC_JVM")) : 1;
int box64_dynarec_wait = env::getEnvVar("BOX64_DYNAREC_WAIT") ? atoi(env::getEnvVar("BOX64_DYNAREC_WAIT")) : 1;
int box64_dynarec_test = env::getEnvVar("BOX64_DYNAREC_TEST") ? atoi(env::getEnvVar("BOX64_DYNAREC_TEST")) : 0;
int box64_dynarec_missing = env::getEnvVar("BOX64_DYNAREC_MISSING") ? atoi(env::getEnvVar("BOX64_DYNAREC_MISSING")) : 0;
int box64_dynarec_trace = env::getEnvVar("BOX64_DYNAREC_TRACE") ? atoi(env::getEnvVar("BOX64_DYNAREC_TRACE")) : 0;
int box64_dynarec_aligned_atomics = env::getEnvVar("BOX64_DYNAREC_ALIGNED_ATOMICS") ? atoi(env::getEnvVar("BOX64_DYNAREC_ALIGNED_ATOMICS")) : 0;
int box64_dynarec_div0 = env::getEnvVar("BOX64_DYNAREC_DIV0") ? atoi(env::getEnvVar("BOX64_DYNAREC_DIV0")) : 0;
