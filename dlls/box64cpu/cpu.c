...
{
    ERR( "not supported yet: x86Syscall\n" );
}
...
NTSTATUS WINAPI BTCpuProcessInit(void)
{
    ...
    TRACE("HERE bop=%p\n", &bopcode);
    TRACE("HERE my_context=%p\n", my_context);
    TRACE("HERE zydis %lld\n", offsetof(box64context_t, zydis));
    TRACE("HERE mutex_dyndump %lld\n", offsetof(box64context_t, mutex_dyndump));
    TRACE("HERE mutex_trace %lld\n", offsetof(box64context_t, mutex_trace));
    TRACE("HERE mutex_bridge %lld\n", offsetof(box64context_t, mutex_bridge));
    TRACE("HERE max_db_size %lld\n", offsetof(box64context_t, max_db_size));
    TRACE("HERE trace_dynarec %lld\n", offsetof(box64context_t, trace_dynarec));
    TRACE("HERE mutex_lock %lld\n", offsetof(box64context_t, mutex_lock));
    TRACE("HERE libclib %lld\n", offsetof(box64context_t, libclib));
    TRACE("HERE emu_sig %lld\n", offsetof(box64context_t, emu_sig));
