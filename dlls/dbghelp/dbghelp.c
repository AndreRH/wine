...
extern struct cpu       cpu_i386, cpu_x86_64, cpu_arm, cpu_arm64, cpu_riscv64;

static struct cpu*      dbghelp_cpus[] = {&cpu_i386, &cpu_x86_64, &cpu_arm, &cpu_arm64, &cpu_riscv64, NULL};
