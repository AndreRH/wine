...
{
    return ppc64_thread_data()->syscall_frame;
}

void set_syscall_frame(void *frame)
{
    ppc64_thread_data()->syscall_frame = frame;
}
...
NTSTATUS context_to_server( context_t *to, const CONTEXT *from )
{
    ...
    to->machine = IMAGE_FILE_MACHINE_POWERPC64;
...
{
    if (from->machine != IMAGE_FILE_MACHINE_POWERPC64) return STATUS_INVALID_PARAMETER;
