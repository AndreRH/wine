...
static unsigned int get_server_context_flags( const void *context, USHORT machine )
{
    ...
    case IMAGE_FILE_MACHINE_POWERPC64:
        ...
        if (flags & CONTEXT_PPC64_FLOATING_POINT) ret |= SERVER_CTX_FLOATING_POINT;
...
static NTSTATUS context_to_server( context_t *to, const void *src, USHORT machine )
{
    ...
    case IMAGE_FILE_MACHINE_POWERPC64:
    {
        ...
        {
            FIXME( "debug registers not supported yet\n" );
        }
        return STATUS_SUCCESS;
    }
...
static SIZE_T get_machine_context_size( USHORT machine )
{
    ...
    case IMAGE_FILE_MACHINE_POWERPC64: return sizeof(PPC64_NT_CONTEXT);
    default: return 0;
    }
}
