...
static void output_syscall_dispatcher(void)
{
    ...
    case CPU_POWERPC64:
        ...
        output( "\tclrldi %s, %s, 52\n", ppc_reg(21), ppc_reg(11) );        /* syscall number */
        output( "\trldicl %s, %s, 52, 62\n", ppc_reg(22), ppc_reg(11) );    /* syscall table number */
        output( "\tlis %s, %s@highest\n", ppc_reg(15), asm_name("KeServiceDescriptorTable") );
        output( "\tori %s, %s, %s@higher\n", ppc_reg(15), ppc_reg(15), asm_name("KeServiceDescriptorTable") );
        output( "\trldicr %s, %s, 32, 31\n", ppc_reg(15), ppc_reg(15) );
        output( "\toris %s, %s, %s@high\n", ppc_reg(15), ppc_reg(15), asm_name("KeServiceDescriptorTable") );
        output( "\tori %s, %s, %s@l\n", ppc_reg(15), ppc_reg(15), asm_name("KeServiceDescriptorTable") );
        output( "\trlwinm %s, %s, 5, 0, 26\n", ppc_reg(22), ppc_reg(22) );
        output( "\tadd %s, %s, %s\n", ppc_reg(22), ppc_reg(22), ppc_reg(15) );
        output( "\tld %s, 16(%s)\n", ppc_reg(15), ppc_reg(22) );            /* table->ServiceLimit */
        output( "\tcmpw cr7, %s, %s\n", ppc_reg(22), ppc_reg(15) );
        output( "\tbgt cr7, 4f\n" );
        ...
        output( "\tld %s, %d(%s)\n", ppc_reg(9),  80, ppc_reg(1) );
        output( "\tld %s, %d(%s)\n", ppc_reg(10), 88, ppc_reg(1) );
        output( "\tld %s, 24(%s)\n", ppc_reg(12), ppc_reg(22) );        /* table->ArgumentTable */
        output( "\tadd %s, %s, %s\n", ppc_reg(12), ppc_reg(12), ppc_reg(21) );
        ...
        output( "\tcmpwi cr7, %s, 0\n", ppc_reg(16) );
        output( "\tbne cr7, 1b\n" );
        output( "2:\tld %s, 0(%s)\n", ppc_reg(12), ppc_reg(22) );       /* table->ServiceTable */
        output( "\trldicr %s, %s, 3, 60\n", ppc_reg(17), ppc_reg(21) );
