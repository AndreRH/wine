...
#define NONVOL_INT_NUMREG_RISCV64 12
#define NONVOL_FP_NUMREG_RISCV64  12

#define NONVOL_INT_SIZE_RISCV64 (NONVOL_INT_NUMREG_RISCV64 * sizeof(DWORD64))
#define NONVOL_FP_SIZE_RISCV64  (NONVOL_FP_NUMREG_RISCV64 * sizeof(double))

typedef union _DISPATCHER_CONTEXT_NONVOLREG_RISCV64
{
    BYTE  Buffer[NONVOL_INT_SIZE_RISCV64 + NONVOL_FP_SIZE_RISCV64];
    struct
    {
        DWORD64 GpNvRegs[NONVOL_INT_NUMREG_RISCV64];
        double  FpNvRegs[NONVOL_FP_NUMREG_RISCV64];
    } DUMMYSTRUCTNAME;
} DISPATCHER_CONTEXT_NONVOLREG_RISCV64;
